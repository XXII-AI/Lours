...
def import_bbox(
    ...
    Returns:
        ...
        :class:`Dataset <libia.dataset.Dataset>` or
        :class:`Evaluator <libia.evaluation.Evaluator`
    """
...
def export_bbox(
    ...
    """Convert bounding boxes in libia's reference to a desired format.
    ...
    Args:
        annotations_df: dataframe containing the annotations in libia's format.
            Must have at least ``box_x_min``, ``box_width``, ``box_y_min``,
            ``box_height`` and ``image_id`` columns.
        images_df: dataframe containing the image sizes in libia's format.
