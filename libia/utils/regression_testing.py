...
from libia.dataset import Dataset, from_parquet

from .testing import assert_dataset_equal


class DataSetRegressionFixture:
    """Libia Dataset Regression fixture implementation used on dataset_regression
    fixture.
    ...
    def check(
        ...
        assert isinstance(dataset, Dataset), (
            "Only libia Datasets are supported on dataframe_regression fixture.\n"
