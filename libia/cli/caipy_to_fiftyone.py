...
from libia.utils import try_import_fiftyone
...
class DatasetUpdateHandler(FileSystemEventHandler):
    ...
    def __init__(
        ...
        Args:
            ...
            fo_dataset: fiftyone dataset object corresponding to the libia dataset.
    ...
    def update_dataset(self) -> None:
        ...
        if len(to_remove) > 0:
            annotations_filter = fo.ViewField("libia_id").is_in(
                common.annotations.index
            )
            images_filter = fo.ViewField("libia_id").is_in(common.images.index)
