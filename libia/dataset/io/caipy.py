...
from libia.dataset import Dataset
from libia.utils import BBOX_COLUMN_NAMES
from libia.utils.testing import assert_columns_properly_normalized, assert_images_valid
...
def load_caipy_split(
    ...
    """Load a particular caipy split folder and convert it to a libia Dataset
...
def from_caipy(
    ...
    Args:
        ...
        booleanize: In the case some attributes are array of enum with unique
            ...
            (see :func:`~libia.dataset.Dataset.booleanize`).
