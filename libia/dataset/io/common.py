...
def to_dataset_object(
    ...
    Args:
        ...
        box_format: expected type of box format. See :mod:`libia.utils.bbox_converter`
            Defaults to "cxwcyh"
...
def parse_annotation_name(
    ...
    Args:
        ...
        split_name_mapping: Dictionary with split names you want to appear in the libia
