...
class Dataset:
    ...
    def check(
        ...
        Args:
            ...
            check_exhaustive: If set to True, will check that all images in the
                ...
                indeed exhaustive
        """
        from libia.utils.testing import full_check_dataset_detection
    ...
    def remove_invalid_images(self, load_images: bool = True) -> Self:
        ...
        Example:
            ...
            {14: 'listen', 15: 'marriage', 22: 'reach'}
        """
        from libia.utils.testing import get_invalid_images
    ...
    def remove_invalid_annotations(
        ...
        """
        from libia.utils.testing import get_malformed_bounding_boxes
    ...
    def get_one_frame(self, n: int) -> tuple[pd.Series, pd.DataFrame]:
        ...
        image info and annotation dataframe. This can be useful when using libia as e.g.
        a pytorch dataset.
    ...
    def merge(
        ...
        Notes:
            ...
            - If possible, booleanized columns for images and annotations will be
              broadcast together.
              See :func:`libia.utils.column_booleanizer.broadcast_booleanization`
        ...
        Example:
            ...
            Traceback (most recent call last):
                ...
            libia.utils.label_map_merger.IncompatibleLabelMapsError: Label maps are incompatible
    ...
    def __sub__(self, other: "Dataset") -> tuple["Dataset", "Dataset", "Dataset"]:
        from libia.utils.difftools import dataset_diff
    ...
    def cap_bounding_box_coordinates(self) -> Self:
        ...
        Example:
            >>> from libia.utils.doc_utils import dummy_dataset
            >>> from libia.utils.testing import assert_bounding_boxes_well_formed
    ...
    def split(
        ...
        Args:
            ...
            earth_mover_regularization: Regularization parameter applied to sinkhorn's
                ...
                :func:`libia.dataset.split.balanced_group.earth_mover_distance`.
                Defaults to 0.
    ...
    def to_fiftyone(
        ...
        See Also:
            ...
            - :mod:`libia.utils.fiftyone_convert`
        """
    ...
    def add_detection_annotation(
        ...
        **other_columns: float | str | ndarray | Sequence[float] | Sequence[str],
        ...
        See Also:
            :mod:`libia.utils.annotations_appender`
