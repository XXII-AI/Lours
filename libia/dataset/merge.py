...
from libia.utils.column_booleanizer import broadcast_booleanization
from libia.utils.label_map_merger import merge_label_maps
from libia.utils.testing import assert_frame_intersections_equal
...
def merge_datasets(
    ...
    Notes:
        - If possible, booleanized columns for images and annotations will be broadcast
          together. See :func:`libia.utils.column_booleanizer.broadcast_booleanization`
