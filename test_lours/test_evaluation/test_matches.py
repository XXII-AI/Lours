...
from lours.evaluation.detection import DetectionEvaluator
...
def test_cocoapi_matches():
    ...
    lours_gt_matches = lours_gt_matches.astype(int)
    lours_gt_matches.index = lours_gt_matches.index.astype(int)
    lours_dt_matches = lours_dt_matches.astype(int)
    lours_dt_matches.index = lours_dt_matches.index.astype(int)
    ...
    assert all(lours_gt_matches == coco_gt_matches)
    assert all(lours_dt_matches == coco_dt_matches)
